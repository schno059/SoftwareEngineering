...
public class MainActivity extends AppCompatActivity
    ...
    //Fragment
    public static Object lastActivity = (MainActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            getSupportFragmentManager().beginTransaction().replace(fragContainer.getId(), fragment).commit();
